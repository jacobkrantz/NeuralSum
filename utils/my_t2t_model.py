...
"""Copied from T2TModel Base Class."""
...
class MyT2TModel(base.Layer):
  ...
  def __init__(self,
    ...
    super(MyT2TModel, self).__init__(
  ...
  def model_fn_sharded(self, sharded_features):
    ...
    if self.use_body_sharded:
      ...
      if "training" in losses:
        log_info("Skipping MyT2TModel top and loss because training loss "
                 "returned from body")
  ...
  def bottom(self, features):
    ...
    if not self._problem_hparams:
      log_warn("Without a Problem, MyT2TModel.bottom is a passthrough.")
      return features
  ...
  def _top_single(self, body_output, target_modality, features):
    if not target_modality:
      log_warn("Without a Problem, MyT2TModel.top is a passthrough.")
      return body_output
  ...
  def set_mode(self, mode):
    ...
    log_info("Setting MyT2TModel mode to '%s'", mode)
  ...
  def eval_autoregressive(self, features=None, decode_length=14):
    ...
    """
    # @jacobkrantz HACK decode_length
    decode_length = 14
  ...
  def _beam_decode(self, features, decode_length, beam_size, top_beams, alpha):
    ...
    """
    raise NotImplementedError("create your own version of _beam_decode")
