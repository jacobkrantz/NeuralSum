...
class MyCustomTransformer(my_t2t_model.MyT2TModel):
  ...
  def __init__(self, *args, **kwargs):
    super(MyCustomTransformer, self).__init__(*args, **kwargs)
...
def fast_decode(encoder_output,
  ...
  if beam_size > 1:  # Beam Search
    ...
    if top_beams == 1:
      ...
      decoded_ids = decoded_ids[:, :top_beams, 1:max_decoded_word_cnt+1]
        ...
        if encoder_output is not None:
          with tf.variable_scope("encdec_attention"):
            y = common_attention.multihead_attention(
                ...
                hparams.attention_dropout,
                max_relative_position=hparams.max_relative_position,
                attention_type=hparams.enc_dec_attention_type,
                block_length=hparams.block_length,
                block_width=hparams.block_width,
                gap_size=hparams.gap_size,
                num_memory_blocks=hparams.num_memory_blocks,
